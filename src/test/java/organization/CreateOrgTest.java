...
public class CreateOrgTest extends BaseClass {
	...
	//	String PASSWORD = fUtil.getDataFromPropertiesFile("pwd");
		...
		String value1 = fUtil.getNumericDataFromExcelFile("orgName", 2, 1);
		 ...
		 * 
		 * String orgName = sh.getRow(2).getCell(0).getStringCellValue() + (int)
		 * (Math.random() * 9999); System.out.println(orgName);
		 * 
		 * 
		 * double phnnum = sh.getRow(2).getCell(1).getNumericCellValue(); long
		 * phnnumLong = (long) phnnum; String phnnumString = String.valueOf(phnnumLong);
...
//		Verification
	...
	//	}
		...
		Assert.assertEquals(phoneName, value1);
	...
	//	}
		...
		Assert.assertEquals(actRating, expRating);
